...
const ONBOARDING_STEPS = [
  {
    ...
    description: "Ваш персональный словарь испанского языка. Добавляйте слова, тренируйтесь и запоминайте легко.",
  },
  {
    icon: <PlusCircle className="w-16 h-16 text-success" />,
    title: "Добавляйте слова",
    description: "Вносите испанские слова с переводом, примерами и тегами. Организуйте словарь как вам удобно.",
  },
  {
